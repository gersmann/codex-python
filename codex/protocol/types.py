...
class ServerDiagnosticsRequestMethod(RootModel[Literal["server/diagnostics"]]):
    root: Annotated[Literal["server/diagnostics"], Field(title="Server/diagnosticsRequestMethod")]
...
class ThreadQueueAddRequestMethod(RootModel[Literal["thread/queue/add"]]):
    root: Annotated[Literal["thread/queue/add"], Field(title="Thread/queue/addRequestMethod")]


class ThreadQueueListRequestMethod(RootModel[Literal["thread/queue/list"]]):
    root: Annotated[Literal["thread/queue/list"], Field(title="Thread/queue/listRequestMethod")]


class ThreadQueueUpdateRequestMethod(RootModel[Literal["thread/queue/update"]]):
    root: Annotated[Literal["thread/queue/update"], Field(title="Thread/queue/updateRequestMethod")]


class ThreadQueueDeleteRequestMethod(RootModel[Literal["thread/queue/delete"]]):
    root: Annotated[Literal["thread/queue/delete"], Field(title="Thread/queue/deleteRequestMethod")]


class ThreadQueueReorderRequestMethod(RootModel[Literal["thread/queue/reorder"]]):
    root: Annotated[
        Literal["thread/queue/reorder"],
        Field(title="Thread/queue/reorderRequestMethod"),
    ]


class ThreadQueueStartRequestMethod(RootModel[Literal["thread/queue/start"]]):
    root: Annotated[Literal["thread/queue/start"], Field(title="Thread/queue/startRequestMethod")]
...
class ProjectListRequestMethod(RootModel[Literal["project/list"]]):
    root: Annotated[Literal["project/list"], Field(title="Project/listRequestMethod")]


class ProjectReadRequestMethod(RootModel[Literal["project/read"]]):
    root: Annotated[Literal["project/read"], Field(title="Project/readRequestMethod")]


class ProjectCreateRequestMethod(RootModel[Literal["project/create"]]):
    root: Annotated[Literal["project/create"], Field(title="Project/createRequestMethod")]


class ProjectImportRequestMethod(RootModel[Literal["project/import"]]):
    root: Annotated[Literal["project/import"], Field(title="Project/importRequestMethod")]


class ProjectUpdateRequestMethod(RootModel[Literal["project/update"]]):
    root: Annotated[Literal["project/update"], Field(title="Project/updateRequestMethod")]


class ProjectMoveRequestMethod(RootModel[Literal["project/move"]]):
    root: Annotated[Literal["project/move"], Field(title="Project/moveRequestMethod")]


class ProjectDeleteRequestMethod(RootModel[Literal["project/delete"]]):
    root: Annotated[Literal["project/delete"], Field(title="Project/deleteRequestMethod")]
...
class PluginSearchRequestMethod(RootModel[Literal["plugin/search"]]):
    root: Annotated[Literal["plugin/search"], Field(title="Plugin/searchRequestMethod")]
...
class TurnSettingsUpdateRequestMethod(RootModel[Literal["turn/settings/update"]]):
    root: Annotated[
        Literal["turn/settings/update"],
        Field(title="Turn/settings/updateRequestMethod"),
    ]
...
class ThreadTimelineListRequestMethod(RootModel[Literal["thread/timeline/list"]]):
    root: Annotated[
        Literal["thread/timeline/list"],
        Field(title="Thread/timeline/listRequestMethod"),
    ]
...
class McpServerEventStreamStartRequestMethod(RootModel[Literal["mcpServer/event/stream/start"]]):
    root: Annotated[
        Literal["mcpServer/event/stream/start"],
        Field(title="McpServer/event/stream/startRequestMethod"),
    ]


class McpServerEventStreamStopRequestMethod(RootModel[Literal["mcpServer/event/stream/stop"]]):
    root: Annotated[
        Literal["mcpServer/event/stream/stop"],
        Field(title="McpServer/event/stream/stopRequestMethod"),
    ]
...
class AccountBedrockDiscoverRequestMethod(RootModel[Literal["account/bedrock/discover"]]):
    root: Annotated[
        Literal["account/bedrock/discover"],
        Field(title="Account/bedrock/discoverRequestMethod"),
    ]


class AccountBedrockSetupRequestMethod(RootModel[Literal["account/bedrock/setup"]]):
    root: Annotated[
        Literal["account/bedrock/setup"],
        Field(title="Account/bedrock/setupRequestMethod"),
    ]
...
class CommandExecutionApprovalKind(RootModel[Literal["command", "writeStdin"]]):
    root: Annotated[
...
class RequestId1(RootModel[str | int]):
...
class BedrockDiscoverParams(BaseModel):
    pass


class Profilev2BedrockSetupParamsType(RootModel[Literal["profile"]]):
    root: Annotated[Literal["profile"], Field(title="Profilev2::BedrockSetupParamsType")]


class Profilev2BedrockSetupParams(BaseModel):
    profile: str
    region: str
    type: Annotated[
        Profilev2BedrockSetupParamsType,
        Field(title="Profilev2::BedrockSetupParamsType"),
    ]


class Environmentv2BedrockSetupParamsType(RootModel[Literal["environment"]]):
    root: Annotated[Literal["environment"], Field(title="Environmentv2::BedrockSetupParamsType")]


class Environmentv2BedrockSetupParams(BaseModel):
    region: str
    type: Annotated[
        Environmentv2BedrockSetupParamsType,
        Field(title="Environmentv2::BedrockSetupParamsType"),
    ]


class BedrockSetupParams(RootModel[Profilev2BedrockSetupParams | Environmentv2BedrockSetupParams]):
    root: Annotated[
        Profilev2BedrockSetupParams | Environmentv2BedrockSetupParams,
        Field(title="BedrockSetupParams"),
    ]
...
class AmazonBedrockAccessKeysv2LoginAccountParams(BaseModel):
    accessKeyId: str
    region: str
    secretAccessKey: str
...
class McpResourceReadParams(BaseModel):
    ...
    originCallId: Annotated[
        str | None,
        Field(description="Originating MCP tool call used to select the resource's app."),
    ] = None
    server: str
    threadId: str | None = None
    uri: str
...
class McpServerEventStreamStartParams(BaseModel):
    field_meta: Annotated[Any | None, Field(alias="_meta")] = None
    arguments: Any
    name: str
    server: str
...
class McpServerEventStreamStopParams(BaseModel):
    subscriptionId: str
...
class ProjectMoveParams(BaseModel):
    beforeProjectId: str | None = None
    projectId: str


class ProjectReadParams(BaseModel):
    projectId: str
...
class ServerDiagnosticsParams(BaseModel):
    pass
...
class ThreadQueueReorderParams(BaseModel):
    queuedSubmissionIds: list[str]
    threadId: str


class ThreadQueueStartParams(BaseModel):
    queuedSubmissionId: str | None = None
    threadId: str
...
class ThreadSectionDeleteParams(BaseModel):
    sectionId: Annotated[
        str,
        Field(description="The stable, server-generated identity of the section to delete."),
    ]
...
class ThreadSectionMoveParams(BaseModel):
    ...
    sectionId: Annotated[
        str | None,
        Field(description="Destination section, or `null` to remove the thread from its section."),
    ]
    threadId: Annotated[str, Field(description="Thread to move into, within, or out of a section.")]
...
class ThreadTimelineListParams(BaseModel):
...
class McpServerOauthClientRegistration(RootModel[Literal["auto", "cimd", "dcr"]]):
    root: Literal["auto", "cimd", "dcr"]
...
class ProjectChangeType(RootModel[Literal["created", "updated", "deleted"]]):
    root: Literal["created", "updated", "deleted"]
...
class ThreadSortKey(
    RootModel[Literal["created_at", "updated_at", "recency_at", "section_position"]]
):
    root: Literal["created_at", "updated_at", "recency_at", "section_position"]
...
class CollabAgentToolCallStatus(
    RootModel[Literal["inProgress", "completed", "failed", "interrupted"]]
):
    root: Literal["inProgress", "completed", "failed", "interrupted"]
...
class HookHandlerType(RootModel[Literal["command", "mcpTool", "prompt", "agent"]]):
    root: Literal["command", "mcpTool", "prompt", "agent"]
...
class SubAgentActivityKind(RootModel[Literal["started", "interacted", "interrupted", "completed"]]):
    root: Literal["started", "interacted", "interrupted", "completed"]
...
class ThreadRealtimeSessionOutcome(RootModel[Literal["ended", "failed"]]):
    root: Literal["ended", "failed"]


class ThreadRealtimeTranscriptRole(RootModel[Literal["user", "assistant"]]):
    root: Literal["user", "assistant"]
...
class ServerDiagnosticsRequest(BaseModel):
    id: RequestId
    method: Annotated[
        ServerDiagnosticsRequestMethod, Field(title="Server/diagnosticsRequestMethod")
    ]
...
class ThreadQueueListRequest(BaseModel):
    id: RequestId
    method: Annotated[ThreadQueueListRequestMethod, Field(title="Thread/queue/listRequestMethod")]
...
class ThreadQueueDeleteRequest(BaseModel):
    id: RequestId
    method: Annotated[
        ThreadQueueDeleteRequestMethod, Field(title="Thread/queue/deleteRequestMethod")
    ]
...
class ThreadQueueReorderRequest(BaseModel):
    id: RequestId
    method: Annotated[
        ThreadQueueReorderRequestMethod,
        Field(title="Thread/queue/reorderRequestMethod"),
    ]
...
class ThreadQueueStartRequest(BaseModel):
    id: RequestId
    method: Annotated[ThreadQueueStartRequestMethod, Field(title="Thread/queue/startRequestMethod")]
...
class ProjectReadRequest(BaseModel):
    id: RequestId
    method: Annotated[ProjectReadRequestMethod, Field(title="Project/readRequestMethod")]
    params: ProjectReadParams


class ProjectMoveRequest(BaseModel):
    id: RequestId
    method: Annotated[ProjectMoveRequestMethod, Field(title="Project/moveRequestMethod")]
    params: ProjectMoveParams


class ProjectDeleteRequest(BaseModel):
    id: RequestId
    method: Annotated[ProjectDeleteRequestMethod, Field(title="Project/deleteRequestMethod")]
...
class ThreadSectionDeleteRequest(BaseModel):
    id: RequestId
    method: Annotated[
        ThreadSectionDeleteRequestMethod,
        Field(title="ThreadSection/deleteRequestMethod"),
    ]
...
class ThreadTimelineListRequest(BaseModel):
    id: RequestId
    method: Annotated[
        ThreadTimelineListRequestMethod,
        Field(title="Thread/timeline/listRequestMethod"),
    ]
...
class McpServerEventStreamStartRequest(BaseModel):
    id: RequestId
    method: Annotated[
        McpServerEventStreamStartRequestMethod,
        Field(title="McpServer/event/stream/startRequestMethod"),
    ]
    params: McpServerEventStreamStartParams


class McpServerEventStreamStopRequest(BaseModel):
    id: RequestId
    method: Annotated[
        McpServerEventStreamStopRequestMethod,
        Field(title="McpServer/event/stream/stopRequestMethod"),
    ]
...
class AccountBedrockDiscoverRequest(BaseModel):
    id: RequestId
    method: Annotated[
        AccountBedrockDiscoverRequestMethod,
        Field(title="Account/bedrock/discoverRequestMethod"),
    ]
    params: BedrockDiscoverParams


class AccountBedrockSetupRequest(BaseModel):
    id: RequestId
    method: Annotated[
        AccountBedrockSetupRequestMethod,
        Field(title="Account/bedrock/setupRequestMethod"),
    ]
...
class ThreadRevertedNotificationModel(BaseModel):
    emittedAtMs: Annotated[
        int | None,
        Field(
            description="Unix timestamp (in milliseconds) when app-server emitted this notification."
    ...
    method: Annotated[
        ThreadRevertedNotificationMethod,
        Field(title="Thread/revertedNotificationMethod"),
    ]
...
class ThreadQueueChangedNotificationModel(BaseModel):
    emittedAtMs: Annotated[
        int | None,
        Field(
            description="Unix timestamp (in milliseconds) when app-server emitted this notification."
    ...
    method: Annotated[
        ThreadQueueChangedNotificationMethod,
        Field(title="Thread/queue/changedNotificationMethod"),
    ]
    params: ThreadQueueChangedNotification


class ThreadProjectUpdatedNotificationModel(BaseModel):
    emittedAtMs: Annotated[
        int | None,
        Field(
            description="Unix timestamp (in milliseconds) when app-server emitted this notification."
...
class AutoApprovalReviewStrictReviewRequiredNotification(BaseModel):
    emittedAtMs: Annotated[
        int | None,
        Field(
            description="Unix timestamp (in milliseconds) when app-server emitted this notification."
...
class ModelProviderAuthRecoveryStartedNotification(BaseModel):
    emittedAtMs: Annotated[
        int | None,
        Field(
            description="Unix timestamp (in milliseconds) when app-server emitted this notification."
...
class ModelProviderAuthRecoveryCompletedNotification(BaseModel):
    emittedAtMs: Annotated[
        int | None,
        Field(
            description="Unix timestamp (in milliseconds) when app-server emitted this notification."
...
class ThreadRealtimeItemTranscriptDeltaNotificationModel(BaseModel):
    emittedAtMs: Annotated[
        int | None,
        Field(
            description="Unix timestamp (in milliseconds) when app-server emitted this notification."
...
class LoginAccountParams(
    RootModel[
        ...
        | AmazonBedrockAccessKeysv2LoginAccountParams
    ]
):
    root: Annotated[
        ApiKeyv2LoginAccountParams
...
class PluginListParams(BaseModel):
    ...
    forceRefetch: Annotated[
        bool | None,
        Field(description="Whether the client requests a fresh remote plugin catalog fetch."),
    ] = None
...
class ProjectImportParams(BaseModel):
    idempotencyKey: str
    metadata: dict[str, Any] | None = None
    name: str
    roots: list[ProjectRoot]
...
class ProjectListParams(BaseModel):
    ...
    sortDirection: Annotated[
        SortDirection | None,
        Field(description="Requires sortKey. Defaults to asc for position and desc for recencyAt."),
    ] = None
    sortKey: Annotated[
        ProjectSortKey | None,
        Field(
...
class ThreadRealtimeStartParams(BaseModel):
    ...
    codexResponseHandoffChannelPrefixes: Annotated[
        dict[str, Any] | None,
        Field(
    ...
    realtimeEndInstructions: Annotated[
        str | None,
        Field(
    ...
    realtimeStartInstructions: Annotated[
        str | None,
        Field(
...
class ThreadSectionUpdateParams(BaseModel):
    ...
    sectionId: Annotated[
        str,
        Field(description="The stable, server-generated identity of the section to update."),
    ]
...
class TurnSettingsUpdateParams(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    approvalsReviewer: Annotated[
    ...
    effort: Annotated[
        ...
        Field(description="Omission or `null` leaves the effort unchanged."),
    ] = None
    model: Annotated[
        str | None, Field(description="Omission or `null` leaves the model unchanged.")
    ] = None
    serviceTier: Annotated[
        ServiceTier | None,
        Field(description="`null` clears the requested tier; omission leaves it unchanged."),
    ] = None
    summary: Annotated[
        ReasoningSummary | None,
        Field(description="Omission or `null` leaves the summary preference unchanged."),
    ] = None
    threadId: str
    turnId: str
...
class BemItemPromotedThreadRealtimeItem(BaseModel):
    ...
    turn_id: str
    type: Annotated[
        BemItemPromotedThreadRealtimeItemType,
        Field(title="BemItemPromotedThreadRealtimeItemType"),
    ]
...
class ProjectListRequest(BaseModel):
    id: RequestId
    method: Annotated[ProjectListRequestMethod, Field(title="Project/listRequestMethod")]
    params: ProjectListParams


class ProjectCreateRequest(BaseModel):
    id: RequestId
    method: Annotated[ProjectCreateRequestMethod, Field(title="Project/createRequestMethod")]
    params: ProjectCreateParams


class ProjectImportRequest(BaseModel):
    id: RequestId
    method: Annotated[ProjectImportRequestMethod, Field(title="Project/importRequestMethod")]
    params: ProjectImportParams


class ProjectUpdateRequest(BaseModel):
    id: RequestId
    method: Annotated[ProjectUpdateRequestMethod, Field(title="Project/updateRequestMethod")]
...
class ThreadSectionCreateRequest(BaseModel):
    id: RequestId
    method: Annotated[
        ThreadSectionCreateRequestMethod,
        Field(title="ThreadSection/createRequestMethod"),
    ]
...
class ThreadSectionUpdateRequest(BaseModel):
    id: RequestId
    method: Annotated[
        ThreadSectionUpdateRequestMethod,
        Field(title="ThreadSection/updateRequestMethod"),
    ]
...
class PluginSearchRequest(BaseModel):
    id: RequestId
    method: Annotated[PluginSearchRequestMethod, Field(title="Plugin/searchRequestMethod")]
    params: PluginSearchParams


class TurnSettingsUpdateRequest(BaseModel):
    id: RequestId
    method: Annotated[
        TurnSettingsUpdateRequestMethod,
        Field(title="Turn/settings/updateRequestMethod"),
    ]
...
class ProjectChangedNotificationModel(BaseModel):
    emittedAtMs: Annotated[
        int | None,
        Field(
            description="Unix timestamp (in milliseconds) when app-server emitted this notification."
    ...
    method: Annotated[
        ProjectChangedNotificationMethod,
        Field(title="Project/changedNotificationMethod"),
    ]
...
class McpServerEventStreamNotificationNotification(BaseModel):
    emittedAtMs: Annotated[
        int | None,
        Field(
            description="Unix timestamp (in milliseconds) when app-server emitted this notification."
...
class FunctionCallOutputThreadItem(BaseModel):
    ...
    output: FunctionCallOutputBody
    type: Annotated[
        FunctionCallOutputThreadItemType,
        Field(title="FunctionCallOutputThreadItemType"),
    ]
...
class ThreadRealtimeItemStartedNotificationModel(BaseModel):
    emittedAtMs: Annotated[
        int | None,
        Field(
            description="Unix timestamp (in milliseconds) when app-server emitted this notification."
...
class ThreadRealtimeItemCompletedNotificationModel(BaseModel):
    emittedAtMs: Annotated[
        int | None,
        Field(
            description="Unix timestamp (in milliseconds) when app-server emitted this notification."
...
class ExternalAgentConfigImportHistoryRecordParams(BaseModel):
    ...
    providerId: Annotated[
        str,
        Field(description="Opaque provider identifier for the externally completed import."),
    ]
...
class ThreadQueueAddRequest(BaseModel):
    id: RequestId
    method: Annotated[ThreadQueueAddRequestMethod, Field(title="Thread/queue/addRequestMethod")]
...
class ThreadQueueUpdateRequest(BaseModel):
    id: RequestId
    method: Annotated[
        ThreadQueueUpdateRequestMethod, Field(title="Thread/queue/updateRequestMethod")
    ]
...
class Thread(BaseModel):
    ...
    sectionEnteredAt: Annotated[
        int | None,
        Field(description="Unix timestamp in seconds when the thread entered its current section."),
    ] = None
    sessionId: Annotated[
        str,
...
type ServerNotificationValue = (
    ...
    | ThreadRevertedNotificationModel
    ...
    | ThreadQueueChangedNotificationModel
    | ProjectChangedNotificationModel
    | ThreadProjectUpdatedNotificationModel
    ...
    | ThreadRealtimeItemStartedNotificationModel
    | ThreadRealtimeItemTranscriptDeltaNotificationModel
    | ThreadRealtimeItemCompletedNotificationModel
...
class AwsCredentialType(RootModel[Literal["accessKeys", "bedrockApiKey"]]):
    root: Literal["accessKeys", "bedrockApiKey"]


class BedrockAwsProfile(BaseModel):
    name: str
    region: str | None = None


class BedrockEnvironmentCredential(BaseModel):
    region: str | None = None
    type: AwsCredentialType


class BedrockDiscoverResponse(BaseModel):
    environmentCredentials: list[BedrockEnvironmentCredential]
    profiles: list[BedrockAwsProfile]


class BedrockSetupResponse(BaseModel):
    pass
...
class AllowDenyRequirement(RootModel[Literal["allow", "deny"]]):
    root: Literal["allow", "deny"]
...
class PackagedDefaultsConfigLayerSource(BaseModel):
    file: Annotated[
        AbsolutePathBuf,
        Field(description="Path to the packaged default configuration file."),
    ]
    type: Annotated[
        PackagedDefaultsConfigLayerSourceType,
        Field(title="PackagedDefaultsConfigLayerSourceType"),
    ]
...
class BrowserUseAccessApprovalLifetime(RootModel[Literal["turn", "thread"]]):
    root: Literal["turn", "thread"]


class BrowserUseOriginPolicy(BaseModel):
    access: AllowDenyRequirement | None = None
    accessApprovalLifetime: BrowserUseAccessApprovalLifetime | None = None
    autoReview: AllowDenyRequirement | None = None
    downloads: AllowDenyRequirement | None = None
    fullCdpAccess: AllowDenyRequirement | None = None
...
class CliAuthCredentialsStoreMode(RootModel[Literal["file", "keyring", "auto", "ephemeral"]]):
    root: Literal["file", "keyring", "auto", "ephemeral"]
...
class McpToolConfiguredHookHandler(BaseModel):
    ...
    tool: str
    type: Annotated[
        McpToolConfiguredHookHandlerType,
        Field(title="McpToolConfiguredHookHandlerType"),
    ]
...
class ManagedHooksRequirements(BaseModel):
    Interrupt: Annotated[list[ConfiguredHookMatcherGroup] | None, Field(validate_default=True)] = []
...
class ComputerUseRequirements(BaseModel):
    ...
    defaultAppAccess: AllowDenyRequirement | None = None
...
class ConfigRequirements(BaseModel):
    ...
    cliAuthCredentialsStore: CliAuthCredentialsStoreMode | None = None
...
class ExternalAgentDetectedConnectorSource(
    RootModel[Literal["remoteMcpServersConfig", "sessionToolUse"]]
):
    root: Literal["remoteMcpServersConfig", "sessionToolUse"]
...
class McpAuthStatus(
    RootModel[Literal["unknown", "unsupported", "notLoggedIn", "bearerToken", "oAuth"]]
):
    root: Literal["unknown", "unsupported", "notLoggedIn", "bearerToken", "oAuth"]
...
class McpServerEventStreamStartResponse(BaseModel):
    pass


class McpServerEventStreamStopResponse(BaseModel):
    pass
...
class MultiAgentVersion(RootModel[Literal["disabled", "v1", "v2"]]):
    root: Annotated[
        Literal["disabled", "v1", "v2"],
        Field(description="Multi-agent runtime supported by a model."),
    ]
...
class Model(BaseModel):
    ...
    multiAgentVersion: Annotated[
        ...
        Field(description="Multi-agent runtime declared by this model, when available."),
    ] = None
...
class PluginDisabledReason(
    ...
    root: Literal["disabled_by_admin", "plan_not_eligible", "required_app_unavailable", "unknown"]
...
class PluginSummary(BaseModel):
    ...
    disabledReason: Annotated[
        ...
        Field(description="Why the remote plugin is unavailable, when provided by plugin-service."),
    ] = None
    eligiblePlanTypes: Annotated[
        list[str] | None,
        Field(description="Raw plugin-service plan identifiers eligible to install the plugin."),
    ] = None
    enabled: bool
    id: str
...
class PluginReconcileChangedPlugin(BaseModel):
    ...
    id: Annotated[
        str,
        Field(description="Local plugin ID (`name@marketplace`), matching `PluginSummary.id`."),
    ]
...
class PluginReconcileResponse(BaseModel):
    ...
    failedRemotePluginIds: Annotated[
        list[str],
        Field(description="Backend remote plugin IDs whose bundle or identity update failed."),
    ]
...
class ServerDiagnosticsResponse(BaseModel):
    gauges: list[ServerDiagnosticsGauge]
...
class ThreadQueueListResponse(BaseModel):
    ...
    nextCursor: Annotated[
        str | None,
        Field(description="Opaque cursor for the next page, or `null` when no submissions remain."),
    ] = None
...
class ThreadSectionListResponse(BaseModel):
    ...
    nextCursor: Annotated[
        str | None,
        Field(description="Opaque cursor for the next page, or `null` when no sections remain."),
    ] = None
...
class TurnStartedThreadTimelineEntry(BaseModel):
    ...
    turn_id: str
    type: Annotated[
        TurnStartedThreadTimelineEntryType,
        Field(title="TurnStartedThreadTimelineEntryType"),
    ]
...
class TurnCompletedThreadTimelineEntry(BaseModel):
    ...
    turn_id: str
    type: Annotated[
        TurnCompletedThreadTimelineEntryType,
        Field(title="TurnCompletedThreadTimelineEntryType"),
    ]
...
class ThreadTimelineListResponse(BaseModel):
    activeRealtimeSessionAtPageStart: str | None = None
    data: list[ThreadTimelineEntry]
    nextCursor: str | None = None
...
class TurnSettingsUpdateStatus(RootModel[Literal["applied"] | Literal["targetUnavailable"]]):
    root: Literal["applied"] | Literal["targetUnavailable"]


class TurnSettingsUpdateResponse(BaseModel):
