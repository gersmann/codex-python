...
#   timestamp: 2026-07-15T14:25:08+00:00
...
class PluginShareUpdateDiscoverability(RootModel[Literal["UNLISTED", "PRIVATE"]]):
    root: Literal["UNLISTED", "PRIVATE"]
...
class ThreadRealtimeStartParams(BaseModel):
    ...
    codexResponseHandoffPrefix: Annotated[
        str | None,
        Field(
...
class AmazonBedrockCredentialSource(RootModel[Literal["codexManaged", "awsManaged"]]):
    root: Literal["codexManaged", "awsManaged"]
...
class AmazonBedrockAccount(BaseModel):
    credentialSource: Annotated[
        AmazonBedrockCredentialSource | None, Field(validate_default=True)
