...
#   timestamp: 2026-06-17T21:22:21+00:00
...
class ThreadTurnsItemsListRequestMethod(RootModel[Literal["thread/turns/items/list"]]):
    root: Annotated[
        Literal["thread/turns/items/list"],
        Field(title="Thread/turns/items/listRequestMethod"),
    ]
...
class ConversationTextRole(RootModel[Literal["user", "developer"]]):
    root: Literal["user", "developer"]
...
class PluginListMarketplaceKind(
    RootModel[Literal["local", "vertical", "workspace-directory", "shared-with-me"]]
):
    root: Literal["local", "vertical", "workspace-directory", "shared-with-me"]
...
class RealtimeConversationArchitecture(RootModel[Literal["realtimeapi", "avas"]]):
    root: Literal["realtimeapi", "avas"]
...
class ThreadRealtimeStartParams(BaseModel):
    architecture: Annotated[
        RealtimeConversationArchitecture | None,
        Field(description="Overrides the configured realtime architecture for this session only."),
    ] = None
    model: Annotated[
        str | None,
...
class ThreadTurnsItemsListRequest(BaseModel):
    id: RequestIdModel
    method: Annotated[
        ThreadTurnsItemsListRequestMethod,
        Field(title="Thread/turns/items/listRequestMethod"),
    ]
