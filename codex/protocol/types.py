...
#   timestamp: 2026-05-18T19:26:21+00:00
...
class ManagedPermissionProfileType(RootModel[Literal["managed"]]):
    root: Annotated[Literal["managed"], Field(title="ManagedPermissionProfileType")]


class DisabledPermissionProfileType(RootModel[Literal["disabled"]]):
    root: Annotated[Literal["disabled"], Field(title="DisabledPermissionProfileType")]


class DisabledPermissionProfile(BaseModel):
    type: Annotated[DisabledPermissionProfileType, Field(title="DisabledPermissionProfileType")]


class ExternalPermissionProfileType(RootModel[Literal["external"]]):
    root: Annotated[Literal["external"], Field(title="ExternalPermissionProfileType")]
...
class PluginListMarketplaceKind(
    RootModel[Literal["local", "workspace-directory", "shared-with-me"]]
):
    root: Literal["local", "workspace-directory", "shared-with-me"]
...
class ThreadGoalStatus(RootModel[Literal["active", "paused", "budgetLimited", "complete"]]):
    root: Literal["active", "paused", "budgetLimited", "complete"]
...
class ThreadSource(RootModel[Literal["user", "subagent", "memory_consolidation"]]):
    root: Literal["user", "subagent", "memory_consolidation"]
...
class FileSystemAccessMode(RootModel[Literal["read", "write", "none"]]):
    root: Literal["read", "write", "none"]
...
class RestrictedPermissionProfileFileSystemPermissionsType(RootModel[Literal["restricted"]]):
    root: Annotated[
        Literal["restricted"],
...
class UnrestrictedPermissionProfileFileSystemPermissionsType(RootModel[Literal["unrestricted"]]):
    root: Annotated[
...
class UnrestrictedPermissionProfileFileSystemPermissions(BaseModel):
    type: Annotated[
        UnrestrictedPermissionProfileFileSystemPermissionsType,
        Field(title="UnrestrictedPermissionProfileFileSystemPermissionsType"),
    ]
...
class ThreadForkParams(BaseModel):
    ...
    runtimeWorkspaceRoots: Annotated[
        list[str] | None,
        Field(
            description="Replace the thread's runtime workspace roots. Relative paths are resolved against the effective cwd for the thread."
        ),
    ] = None
...
class ExternalPermissionProfile(BaseModel):
    ...
    type: Annotated[ExternalPermissionProfileType, Field(title="ExternalPermissionProfileType")]
...
class RestrictedPermissionProfileFileSystemPermissions(BaseModel):
    ...
    type: Annotated[
        RestrictedPermissionProfileFileSystemPermissionsType,
        Field(title="RestrictedPermissionProfileFileSystemPermissionsType"),
    ]
...
class ManagedPermissionProfile(BaseModel):
    ...
    network: PermissionProfileNetworkPermissions
    type: Annotated[ManagedPermissionProfileType, Field(title="ManagedPermissionProfileType")]
...
class NetworkUnixSocketPermission(RootModel[Literal["allow", "none"]]):
    root: Literal["allow", "none"]
